...
class Social::PaymentMethodSerializer < ActiveModel::Serializer
  attributes :id, :payment, :amount, :serial, :currency, :status, :details, :client, :tickets, :raffle, :has_fly_amount, :capture, :tickets_count, :fly_amounts, :fractions, :fraction_debt, :is_fractionated, :payment_rate, :created_at
